...
def decrypt_api_key(encrypted_key: str) -> str:
    ...
    # Verificar se o valor é None, vazio ou inválido
    if not encrypted_key or encrypted_key.strip() == '' or encrypted_key.lower() == 'none':
        return None
    ...
    try:
        ...
        if decrypted:
            ...
            return None  # Retornar None em vez de string de erro
    except Exception as e:
