...
class User(db.Model):
    ...
    # Campos do Stripe
    subscription_status = db.Column(db.String(50), nullable=True)  # active, canceled, incomplete, etc.
    subscription_id = db.Column(db.String(255), nullable=True)  # ID da assinatura no Stripe
