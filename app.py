...
SUBSTITUI A APLICAÇÃO ORIGINAL PARA RESOLVER OS ERROS
"""
...
# Criar função create_app para compatibilidade com gunicorn
def create_app():
    return app

# Criar variável application para compatibilidade com gunicorn
application = app
