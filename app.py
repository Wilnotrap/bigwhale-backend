...
def create_app(config_name='default'):
    ...
    from api import api_credentials_bp  # Importa o novo blueprint
    ...
    app.register_blueprint(api_credentials_bp, url_prefix='/api')  # Registra o novo blueprint

    # Inicializar SecureAPIService e registrar suas rotas
    # Inicializar SecureAPIService (versão corrigida)
    # secure_api_service = SecureAPIService(app) # Removido inicialização redundante
    ...
    # Inicialize SecureAPIService, passando apenas 'app'
