...
# Adicionar na rota de sessão
@auth_bp.route('/session', methods=['GET'])
def check_session():
    """Verifica se o usuário está logado e retorna informações da sessão"""
    try:
        ...
        return jsonify({
            ...
            'can_access_system': user.is_admin or subscription_active
        }), 200
        
    except Exception as e:
        current_app.logger.error(f"Erro ao verificar sessão: {e}")
