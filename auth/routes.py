...
def register():
    ...
    try:
        ...
        # Validar código de convite apenas se não for usuário pagante
        ...
        if paid_user:
            ...
            if not invite_code_used:
                print(f"❌ Código de convite inválido: '{invite_code_attempt}'")
                return jsonify({
                    'message': 'Código de convite obrigatório e inválido. Verifique se digitou corretamente ou realize o pagamento.',
