...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = [full_name, email, password, confirmPassword, bitget_api_key, bitget_api_secret, bitget_passphrase, invite_code];
